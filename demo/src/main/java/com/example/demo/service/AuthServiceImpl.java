 ...
 * Обрабатывает вход, обновление токенов, выход и предоставляет информацию о текущем пользователе.
 */
@Service
...
public class AuthServiceImpl implements AuthService {
     ...
     * Также отправляет уведомление в Telegram о попытке входа.
     *
     ...
     * Отправляет уведомление в Telegram о выходе пользователя из системы.
     *
     ...
     * Обрабатывает различные заголовки, которые могут содержать IP-адрес,
     * такие как X-Forwarded-For, Proxy-Client-IP и другие.
     *
     * @return IP-адрес клиента или "unknown", если адрес не найден
     */
